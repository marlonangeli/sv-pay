              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    disabled={account.status !== accountStatusEnum.Active}/>
                </FormControl>
                <FormMessage/>
              </FormItem>
            )}/>
                ...
                <FormControl>
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem disabled={account.status === accountStatusEnum.Blocked}
                                  value="Inactive">Inactive</SelectItem>
                      <SelectItem disabled={account.status === accountStatusEnum.Inactive}
                                  value="Blocked">Blocked</SelectItem>
                    </SelectContent>
                  </Select>
                </FormControl>
                <FormMessage/>
